app.controller("forecastControl",function($scope, $http){
	...
	function cityfetch(){
		$http.get("http://chathamweatherapi.azurewebsites.net/api/cities/search?byName="+$scope.cityID
	...
	function placeDetail(){
		$http.get("http://chathamweatherapi.azurewebsites.net/api/cities/"+$scope.placeid
).then(function(response){
	...
	function forecastfetch(){
		$http.get("http://chathamweatherapi.azurewebsites.net/api/forecast?latitude="+$scope.lat+"&longitude="+$scope.long+"&source=FORECAST_IO").then(function(response){
